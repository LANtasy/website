...
urlpatterns = patterns('website.apps.badgebro.views',
    ...
    url(r'^frontdesk/(?P<uid>BA\w{32})/printed/$', 'badge_printed', name='badge_printed'),
    url(r'^frontdesk/(?P<uid>BA\w{32})/collected/$', 'badge_collected', name='badge_collected'),
    url(r'^frontdesk/(?P<uid>BA\w{32})/print/$', 'badge_print_close', name='badge_print'),
